...
class AdminTrabajadoresView(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.usuario_entry.grid(row=3, column=1, padx=10, pady=10)
        ...
        # Botón para cancelar la selección del trabajador
        ...
        # Listbox para mostrar trabajadores
        self.listbox_trabajadores = tk.Listbox(main_frame, font=("Helvetica", 12), height=10)
        self.listbox_trabajadores.grid(row=6, column=0, columnspan=2, padx=10, pady=10, sticky="ew")
    ...
    def bind_eventos(self):
        ...
        campos = [self.nombre_entry, self.usuario_entry, self.password_entry]
    ...
    def agregar_trabajador(self):
        ...
        if nombre and usuario and password:
            create_trabajador(nombre, usuario, password)
    ...
    def modificar_trabajador(self):
        ...
        if self.selected_id is not None:
            ...
            if nuevo_nombre and nuevo_usuario and nuevo_password:
                ...
                update_trabajador(self.selected_id, nuevo_nombre, nuevo_usuario, nuevo_password)
