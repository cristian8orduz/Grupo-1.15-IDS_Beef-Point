...
class EditarPedidoView(tk.Toplevel):
    def __init__(self, parent, pedido_id):
        ...
        self.configure(bg="#2C3E50")  # Fondo oscuro para un aspecto moderno
    ...
    def mostrar_detalles(self):
        ...
        categoria_label = tk.Label(self, text="Productos del Pedido Actual:", font=("Helvetica", 14, "bold"), bg="#2C3E50", fg="white")
        ...
        categoria_label = tk.Label(self, text="Agregar más Productos por Categoría:", font=("Helvetica", 14, "bold"), bg="#2C3E50", fg="white")
        categoria_label.pack(pady=10)
        
        self.categoria_var = tk.StringVar(self)
        self.categoria_var.set("Seleccionar Categoría")
        self.categoria_dropdown = ttk.Combobox(self, textvariable=self.categoria_var, values=[cat.nombre for cat in categorias], font=("Helvetica", 12))
        self.categoria_dropdown.pack(pady=10)
        self.categoria_dropdown.bind("<<ComboboxSelected>>", self.mostrar_productos_categoria)

        self.producto_frame = tk.Frame(self, bg="#2C3E50")
        self.producto_frame.pack(pady=20, fill=tk.BOTH, expand=True, padx=10)

        # Botón para guardar todos los cambios
        save_button = tk.Button(self, text="Guardar Cambios", command=self.guardar_cambios, font=("Helvetica", 12, "bold"), bg="#27AE60", fg="white", relief="flat", cursor="hand2")
